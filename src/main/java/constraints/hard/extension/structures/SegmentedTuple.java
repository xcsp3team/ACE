...
public final class SegmentedTuple {
	...
	/**
	 * globalac[x] is a reference to the array ac managed by the restriction where x is involved (no overlap possible between restrictions) if x is
	 * not involved in any restriction, we have globalac[x] equal to null
	 */
