...
public final class ExtensionRPWC2 extends ExtensionRPWC {
	...
	protected long nAssignmentsAtLastCall = 0;

	public ExtensionRPWC2(Problem pb, Variable[] scp) {
		super(pb, scp);
	...
	protected void manageLastPastVariable() {
		...
		if (nAssignmentsAtLastCall != nb) {
			nAssignmentsAtLastCall = nb;
